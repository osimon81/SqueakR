...
## Inter-group Summary [Dev]

Once we've added all of our data to our experiment, we can request a summary of our variables, grouped by the experimental groups we've set in order to inspect how distributed the data are:
...
SqueakR also has a function for calculating ANOVA between the different groups, which can is run below:
