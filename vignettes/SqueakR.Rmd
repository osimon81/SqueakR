...
## 3D Surface Plot [GitHub Release]
...
```{r surface plot}
plotCallDataSurface(experiment$experimental_data[1]$call_data$raw)
```


## Sunburst Plots [GitHub Release]
...
additional_data <- score_timepoint_data(data_subset = additional_data, group = "AB",
                                        animal = "2173",
...
Adding more uses of Report package functions (on [CRAN](https://cran.r-project.org/package=report/) and [GitHub](https://github.com/easystats/report/)) to SqueakR will allow processed data to connect directly to statistical analyses, and would be useful for processing DeepSqueak data.
